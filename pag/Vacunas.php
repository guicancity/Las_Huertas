...
<?php 
	...
	?>	
    <title>Las huertas || Vacunas</title>
<body>
	<div class="container">
		<form  method="POST">
			<div class="row">
				<div class="col-10 text-center mt-4">
					<h3>Registro de vacunas por animal</h3>
				</div>
			</div>
			<div class="row my-4">
			...
			<div class="row my-4">
				<div class="col-3 text-right">
					<h5>Vacuna aplicada:</h5>
				</div>
				<div class="col-6">
					<select id="sltPurga" class="custom-select" >
						<?php 
						
						$sql = mysqli_query($conexion,"SELECT IDPRODUCTOS, NOMBRE FROM PRODUCTOS WHERE TIPO = 1");
